...
```bash
# Clone repository
git clone https://github.com/eliashaeussler/task-runner.git
cd task-runner
...
Once the changes are ready, please [submit a pull request](https://github.com/eliashaeussler/task-runner/compare)
